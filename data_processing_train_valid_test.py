...
#saving functions
def save_tuple_data(data_dir, data_identifier,window_size):
    ...
    for data_identifier in ['FD001','FD002','FD003','FD004']:
        ...
        cmapps_train_valid_test[data_identifier]=data_proc
    torch.save(cmapps_train_valid_test,'../processed_data/cmapps_train_valid_test_tup.pt')
...
def save_dic_data(data_dir,data_identifier,window_size):
    ...
    torch.save(cmapps_train_valid_test,'processed_data/cmapss_train_valid_test_dic.pt')
...
data_dir = 'data/'
data_identifier =['FD001','FD002','FD003','FD004']
window_size =30

save_dic_data(data_dir,data_identifier,window_size)
